...
\begin{tikzpicture}[remember picture]
    \node (image) at (0,0) {\includegraphics[width=1.0\textwidth]{./fid_per_iterations.png}};
    % \draw[red,ultra thick,rounded corners] (-5,-5) rectangle (5,5);
    % \draw[help lines,xstep=1.0,ystep=1.0] (-15,-15) grid (15,15);
    \foreach \i/\j in {(-9.9,4)/a, (-3, -3)/b, (3.5, -3)/c, (10, -7)/d, (16.5, 8)/e} \draw [red,->, line width=5pt] ({pic cs:\j}) -- \i;
\end{tikzpicture}
\end{tcolorbox}
\bigskip
